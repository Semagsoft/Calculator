...
# Builds Calculator.app and Calculator-<version>.dmg on macOS.
...
DMG="$SCRIPT_DIR/Calculator-$VERSION.dmg"
...
cmake -S "$PROJECT_DIR" -B "$BUILD_DIR" -DCMAKE_BUILD_TYPE=Release -DBUILD_TESTS=OFF
